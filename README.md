...
![Build with Hugo](https://github.com/techatpark/gurukulams-book/workflows/Build%20with%20Hugo/badge.svg)

### [Hugo](https://gohugo.io) documentation theme as simple as plain book

![Screenshot](https://github.com/techatpark/gurukulams-book/blob/master/images/screenshot.png)
...
```
git submodule add https://github.com/techatpark/gurukulams-book themes/gurukulams-book
```

Then run hugo (or set `theme = "gurukulams-book"`/`theme: gurukulams-book` in configuration file)

```
hugo server --minify --theme gurukulams-book
```
...
[module]
[[module.imports]]
path = 'github.com/techatpark/gurukulams-book'
```
...
git init
git submodule add https://github.com/techatpark/gurukulams-book themes/gurukulams-book
cp -R themes/gurukulams-book/exampleSite/content .
```
...
- [Example menu](https://github.com/techatpark/gurukulams-book/blob/master/exampleSite/content.en/menu/index.md)
- [Example config file](https://github.com/techatpark/gurukulams-book/blob/master/exampleSite/config.yaml)
...
You can also see the `yaml` example [here](https://github.com/techatpark/gurukulams-book/blob/master/exampleSite/config.yaml).
...
[params]
  ...
  BookRepo = 'https://github.com/techatpark/gurukulams-book'
...
- [Buttons](https://gurukulams-book-demo.netlify.app/docs/shortcodes/buttons/)
- [Columns](https://gurukulams-book-demo.netlify.app/docs/shortcodes/columns/)
- [Details](https://gurukulams-book-demo.netlify.app/docs/shortcodes/details/)
- [Hints](https://gurukulams-book-demo.netlify.app/docs/shortcodes/hints/)
- [KaTeX](https://gurukulams-book-demo.netlify.app/docs/shortcodes/katex/)
- [Mermaid](https://gurukulams-book-demo.netlify.app/docs/shortcodes/mermaid/)
- [Tabs](https://gurukulams-book-demo.netlify.app/docs/shortcodes/tabs/)
